    ...
    <div className="w-full max-w-7xl mx-auto space-y-8 animate-fadeIn pb-12">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 sm:pb-4 border-b border-slate-100 dark:border-blue-900/25">
          ...
          {selectedLesson && (
            <div className="flex items-center gap-2.5 self-start sm:self-auto">
              ...
              <span className="px-3 py-1 bg-slate-100 dark:bg-[#070B18] border border-slate-200 dark:border-blue-900/30 text-slate-700 dark:text-slate-300 text-xs font-medium rounded-lg font-mono">
        ...
        <div
          ...
          className={`relative w-full bg-slate-950 rounded-2xl overflow-hidden border border-slate-800/80 dark:border-blue-900/40 shadow-[0_8px_30px_rgba(0,0,0,0.25)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.5),0_0_24px_rgba(37,99,235,0.15)] flex items-center justify-center group select-none ${
            isFullscreen
        ...
        >
          ...
          {isFullscreen && selectedLesson && (
            <div
              ...
              className={`absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6 z-50 bg-slate-900/65 dark:bg-[#070B18]/75 backdrop-blur-xl border border-white/15 dark:border-blue-900/40 rounded-2xl p-3 sm:p-4 shadow-2xl space-y-3 transition-all duration-300 ease-out ${
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-white">
                ...
                <div className="flex items-center justify-between sm:justify-end gap-2 sm:gap-3 border-t sm:border-t-0 border-white/10 pt-2 sm:pt-0">
                  ...
                  <div className="flex items-center gap-0.5 sm:gap-1 bg-black/40 border border-white/10 dark:border-blue-900/40 rounded-xl p-1 shadow-inner shrink-0">
                    {[0.5, 1, 1.5, 2].map((spd) => (
                      <button
                        key={spd}
        ...
        {selectedLesson && !isFullscreen && (
          <div
            ...
            className="p-4 sm:p-5 rounded-2xl bg-white dark:bg-[#0B1228] border border-slate-200/90 dark:border-blue-900/30 shadow-md dark:shadow-[0_8px_30px_rgba(0,0,0,0.35)] space-y-3 sm:space-y-4"
          >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 pt-0.5">
              ...
              <div className="flex items-center justify-center sm:justify-start gap-2.5 sm:gap-3">
                ...
                <button
                  ...
                  onClick={handleRewind}
                  disabled={hasError}
                  className="h-10 w-10 sm:h-9 sm:w-9 rounded-xl bg-slate-50 hover:bg-slate-100 dark:bg-[#070B18] dark:hover:bg-blue-950/40 border border-slate-200/90 dark:border-blue-900/30 text-slate-700 dark:text-slate-300 transition-all cursor-pointer active:scale-95 shadow-xs flex items-center justify-center shrink-0"
              ...
              <div className="flex items-center justify-between sm:justify-end gap-2 sm:gap-3.5 border-t sm:border-t-0 border-slate-100 dark:border-blue-900/20 pt-2.5 sm:pt-0">
                {/* 4. PLAYBACK SPEED (0.5x | 1x | 1.5x | 2x) */}
                <div className="flex items-center gap-0.5 sm:gap-1 bg-slate-100 dark:bg-[#070B18] border border-slate-200/90 dark:border-blue-900/30 rounded-xl p-1 shadow-inner shrink-0">
                  {[0.5, 1, 1.5, 2].map((spd) => (
                    <button
                      key={spd}
