  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-between p-3.5 sm:p-4 rounded-2xl bg-white dark:bg-[#0B1228] border border-slate-200 dark:border-purple-500/25 shadow-xs">
        ...
        <div className="mt-3 pt-2 border-t border-slate-100 dark:border-purple-500/20 flex items-center justify-between text-[10px] font-mono text-slate-400">
      ...
      <div className="flex flex-col justify-between p-3.5 sm:p-4 rounded-2xl bg-white dark:bg-[#0B1228] border border-slate-200 dark:border-purple-500/25 shadow-xs">
        <div>
          <div className="flex items-center justify-between pb-2 border-b border-slate-100 dark:border-purple-500/20">
            ...
            <span className="text-[10px] font-mono text-purple-600 dark:text-purple-400 font-bold">Tools Guide</span>
          </div>

          {isReferenceOnly ? (
            <div className="mt-2 space-y-1.5 text-[11px]">
              <div className="grid grid-cols-2 gap-1.5">
                <div className="p-1.5 rounded-lg bg-purple-50/70 dark:bg-purple-950/40 border border-purple-100 dark:border-purple-500/20">
                  <div className="flex items-center gap-1 text-purple-700 dark:text-purple-300 font-mono font-bold text-[10px]">
                ...
                <div className="p-1.5 rounded-lg bg-indigo-50/70 dark:bg-indigo-950/40 border border-indigo-100 dark:border-indigo-500/20">
                  <div className="flex items-center gap-1 text-indigo-700 dark:text-indigo-300 font-mono font-bold text-[10px]">
              ...
              <div className="text-[9px] text-slate-500 dark:text-slate-400 text-center pt-0.5">
                ⚡ Interactive controls active in <strong className="text-indigo-600 dark:text-indigo-400">Workspace</strong>
              </div>
            </div>
          ) : (
        ...
        {onSwitchToPlay && (
          <div className="mt-2 pt-1.5 border-t border-slate-100 dark:border-purple-500/20">
            <button
              onClick={onSwitchToPlay}
              className="w-full py-1 px-2 rounded-lg bg-purple-50 dark:bg-purple-950/60 hover:bg-purple-100 text-purple-700 dark:text-purple-300 text-[10px] font-bold flex items-center justify-center gap-1 transition-colors cursor-pointer"
            >
      ...
      <div className="flex flex-col justify-between p-3.5 sm:p-4 rounded-2xl bg-white dark:bg-[#0B1228] border border-slate-200 dark:border-purple-500/25 shadow-xs">
        ...
        <div className="mt-3 pt-2 border-t border-slate-100 dark:border-purple-500/20 text-[10px] font-mono text-slate-400">
      ...
      <div className="flex flex-col justify-between p-3.5 sm:p-4 rounded-2xl bg-white dark:bg-[#0B1228] border border-slate-200 dark:border-purple-500/25 shadow-xs">
        <div>
          <div className="flex items-center justify-between pb-2 border-b border-slate-100 dark:border-purple-500/20">
            ...
            <span className="text-[10px] font-mono text-cyan-600 dark:text-cyan-400 font-bold">Heap State</span>
          </div>
        ...
        <div className="mt-3 pt-2 border-t border-slate-100 dark:border-purple-500/20 text-[10px] font-mono text-slate-400 truncate">
          <span>Allocated: </span>
