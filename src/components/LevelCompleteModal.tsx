...
export const LevelCompleteModal: React.FC<LevelCompleteModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-editorial-fade font-sans">
      <div className="bg-white dark:bg-[#0B1228] w-full max-w-md border border-slate-200 dark:border-blue-900/30 rounded-2xl shadow-xl dark:shadow-[0_0_30px_rgba(37,99,235,0.25)] overflow-hidden p-6 sm:p-8 flex flex-col items-center text-center">
        {/* Victory Icon */}
        <div className="w-14 h-14 rounded-2xl bg-[#EFF6FF] dark:bg-blue-950/50 border border-blue-100 dark:border-blue-900/30 text-[#2563EB] dark:text-blue-400 flex items-center justify-center mb-3 shadow-xs">
          <Award className="w-8 h-8" />
        </div>

        <span className="text-[11px] font-bold font-mono uppercase tracking-widest text-[#2563EB] dark:text-blue-300 bg-[#EFF6FF] dark:bg-blue-950/60 px-3 py-1 rounded-md border border-blue-100 dark:border-blue-900/30 mb-2">
        ...
        <div className="my-4 p-4 bg-slate-50 dark:bg-[#080D1F] border border-slate-200 dark:border-blue-900/20 rounded-xl w-full text-left">
          ...
          <div className="mt-3 pt-3 border-t border-slate-200 dark:border-blue-900/20 flex items-center justify-between text-xs font-mono">
            <span className="text-slate-500 dark:text-slate-400 font-semibold">Core Formula:</span>
            <span className="font-bold text-[#2563EB] dark:text-blue-300 bg-white dark:bg-[#050816] px-2.5 py-1 rounded-md border border-slate-200 dark:border-blue-900/30">
