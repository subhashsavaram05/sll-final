    ...
    >
      ...
      >
        ...
        <button
          ...
          className="absolute top-4 right-4 p-2 bg-slate-50 dark:bg-[#080D1F] border border-slate-200 dark:border-blue-900/30 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-blue-950/40 hover:text-slate-900 dark:hover:text-white rounded-xl transition-colors cursor-pointer"
        >
          <X className="w-5 h-5" />
        </button>

        {/* Certificate Header Badge */}
        <div className="text-center pb-6 border-b border-slate-100 dark:border-blue-900/20">
        ...
        <div className="my-6 p-5 sm:p-6 bg-slate-50 dark:bg-[#080D1F] border border-slate-200 dark:border-blue-900/25 rounded-2xl">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pb-4 border-b border-slate-200 dark:border-blue-900/20">
            <div>
              <div className="flex items-center gap-2 text-xs font-semibold text-blue-600 dark:text-blue-400 uppercase font-mono">
            ...
            {/* Official Seal */}
            <div className="shrink-0 flex items-center gap-3 px-3.5 py-2 bg-white dark:bg-[#0F1733] rounded-xl border border-slate-200 dark:border-blue-900/30 shadow-2xs">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 my-4">
            ...
            <div className="p-3 bg-white dark:bg-[#0B1228] border border-slate-200 dark:border-blue-900/25 rounded-xl shadow-2xs">
              ...
              <div className="text-lg font-bold text-blue-600 dark:text-blue-400 font-mono">100% COMPLETE</div>
            </div>
            <div className="p-3 bg-white dark:bg-[#0B1228] border border-slate-200 dark:border-blue-900/25 rounded-xl shadow-2xs">
          ...
          <div className="mt-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
              {competencies.map((comp) => (
                <div
                  key={comp.code}
                  className="flex items-center justify-between p-2.5 bg-white dark:bg-[#0B1228] border border-slate-200 dark:border-blue-900/25 rounded-xl shadow-2xs"
                >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-4 border-t border-slate-100 dark:border-blue-900/20">
          <button
